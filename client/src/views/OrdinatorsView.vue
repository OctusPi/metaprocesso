...
function toggleUI(mode = null) {
    ...
    if (page.value.uiview.register) {
        ...
        page.value.title.primary = 'Listagem de Ordenadores'
        page.value.title.secondary = `Foram localizados ${(page.value.datalist.length).toString().padStart(2, '0')} Ordenadores inseridos no sistema`
    }
}
    ...
    <main class="container-primary">
        ...
        <section class="container-main">
            <MainHeader :header="{
                ...
                title: 'Gerenciamento de Ordenadores',
                description: 'Registro de Ordenadores vinculados as Unidades do Orgão'
            }" />
