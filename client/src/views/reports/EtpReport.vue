        ...
        <div class="signatures mt-4">
            <div class="user-signatures text-center">
                ...
                <div class="row gap-3 justify-content-center mt-3">
                    <div v-for="person in etp.process.dfds.map(item => item.demandant)" :key="person.id"
                        class="col-12 mx-5">
            ...
            <div class="comission-signatures text-center mt-4">
                ...
                <div class="row gap-3 justify-content-center mt-3">
                    <div v-for="person in etp.process.comission_members" :key="person.id" class="col-12 mx-5">
                        <strong class="signature">{{ person.name }}</strong>
            ...
            <div class="user-signatures text-center mt-4">
                <h1>APROVADO POR</h1>
                <div class="row gap-3 justify-content-center mt-3">
                    <div v-for="person in etp.process.dfds.map(item => item.ordinator)" :key="person.id"
                        class="col-12 mx-5">
                        <strong class="signature">{{ person.name }}</strong>
