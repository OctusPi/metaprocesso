...
<template>
    ...
    <main>
        ...
        <div class="mb-3">
            <TableListReport :smaller="true" :count="false" :header="items.headers_list" :body="dfd?.items" :mounts="{
                'item.type': [Mounts.Cast(props.selects?.items_types)],
                'dotation': [Mounts.Cast(props.selects?.dotations, 'id', 'name')],
                'program': [Mounts.Cast(props.selects?.programs, 'id', 'name')],
