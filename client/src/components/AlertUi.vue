...
<template>
    <div class="wall w-100 vh-100 position-fixed top-0 start-0" :class="alert.show ? 'd-block' : 'd-none'">
        <div class="position-absolute top-50 start-50 translate-middle box-alert p-4 text-center shadow-sm">
            ...
            <button @click="alert.show = false" type="button" class="btn btn-alert shadow-sm mx-auto mt-4" :class="alerts[alert.data.type]?.btn">
